...
export default function Readmore() {
  return (
    <div className="container">
        <div className="row">
          <div id="div_text" className="col-sm" style={{ marginTop: "1.5em", marginLeft: "4em", marginRight: "4em", paddingLeft: "0", paddingRight: "0" }}>
            <h1 style={{ marginBottom: "1.5em" }}>WHO WE ARE</h1>
            ...
            <div className="container" id="rd" style={{ marginTop: "1em" }}>
